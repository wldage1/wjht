...
public class JCaptchaEngine extends ListImageCaptchaEngine {
	...
	private static final Integer MIN_WORD_LENGTH = 6;// 验证码最小长度
	private static final Integer MAX_WORD_LENGTH = 6;// 验证码最大长度
	private static final Integer IMAGE_HEIGHT = 30;// 验证码图片高度
	private static final Integer IMAGE_WIDTH = 80;// 验证码图片宽度
	private static final Integer MIN_FONT_SIZE = 18;// 验证码最小字体
	private static final Integer MAX_FONT_SIZE = 18;// 验证码最大字体
