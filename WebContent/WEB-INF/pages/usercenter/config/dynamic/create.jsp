			...
			<form:form method="post" action="save" commandName="dictionary">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
					<tr>
						...
						<form:select path="dictSortValue" items="${dictionarySortList}" itemValue="value" itemLabel="name"/>
					...
					<tr>
						...
						<form:input path="name" maxlength="20" onchange="this.value=$.trim(this.value)"/><font color="red">&nbsp;*&nbsp;<form:errors path="name" delimiter=","/></font>
						</td>
					</tr>
					<tr>
						...
						<td width="70%" class="skinLayout_lable">
						<form:input path="value" maxlength="3"/><font color="red">&nbsp;*&nbsp;<form:errors path="value" delimiter=","/></font>
						</td>
					</tr>
					<tr>
						...
						<td width="70%" class="skinLayout_lable">
						<form:textarea cols="40" rows="6" path="description" onchange="this.value=$.trim(this.value)" /><font color="red">&nbsp;&nbsp;<form:errors path="description" /></font>
						</td>
					</tr>	
					<tr>
