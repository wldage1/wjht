			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
				<tr>
					...
					<td width="85%" class="skinLayout_lable">
						<form:select path="orgId" items="${orgList}" itemValue="id" itemLabel="name" ></form:select>
				...
				<tr>
					...
					<td width="85%" class="skinLayout_lable">
					<form:input path="name" value="${role.name}" maxlength="25"/><font color="red">&nbsp;*&nbsp;<form:errors path="name" delimiter=","/></font>
					</td>
				</tr>
				<tr>
					...
					<form:input path="description" value="${role.description}" maxlength="250"/><font color="red">&nbsp;&nbsp;<form:errors path="description" /></font>
					</td>
				</tr>	
				<tr>
