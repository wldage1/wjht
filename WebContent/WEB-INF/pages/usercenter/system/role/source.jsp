	...
	<tr>
		<td width="100%">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
				...
				<tr>
					<td width="15%" align="right" class="skinLayout_info"><msg:message code="role.select.source"/><msg:message code="system.common.sign.colon"/></td>
					<td width="70%">
						<div>
