		...
		<td width="100%">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
				<tr>
					...
					<input name="parentName" type="text" maxlength="20" value="${organization.parentName}" readonly id="parentName" style="width: 200;" /> 
				...
				<tr>
					...
					<td width="85%" class="skinLayout_lable">
					<form:input path="code" value="${organization.code}" maxlength="30"/><font color="red">&nbsp;*&nbsp;<form:errors path="code" /></font>
					</td>
				</tr>
				<tr>
					...
					<td width="85%" class="skinLayout_lable">
					<form:input path="name" value="${organization.name}" maxlength="50"/><font color="red">&nbsp;*&nbsp;<form:errors path="name" delimiter=","/></font>
					</td>
				</tr>
				<tr>
					...
					<td width="85%" class="skinLayout_lable">
					<form:input path="phone" value="${organization.phone}" maxlength="15"/><font color="red">&nbsp;&nbsp;<form:errors path="phone" /> </font>
					</td>
				</tr>
				<tr>
					...
					<td width="85%" class="skinLayout_lable">
					<form:input path="fax" maxlength="15" value="${organization.fax}"/><font color="red">&nbsp;&nbsp;<form:errors path="fax" delimiter=","/></font>
					</td>
				</tr>
				<tr>
					...
					<td width="85%" class="skinLayout_lable">
					<form:input path="postCode" value="${organization.postCode}" maxlength="10"/><font color="red">&nbsp;&nbsp;<form:errors path="postCode" /></font>
					</td>
				</tr>
				<tr>
					...
					<td width="85%" class="skinLayout_lable">
					<form:input path="address" value="${organization.address}" maxlength="250"/><font color="red">&nbsp;&nbsp;<form:errors path="address" /></font>
					</td>
				</tr>																														
				<tr>
					...
					<form:input path="description" value="${organization.description}" maxlength="250"/><font color="red">&nbsp;&nbsp;<form:errors path="description" /></font>
					</td>
				</tr>	
				<tr>
