	...
	<tr>
		<td width="100%">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
				<tr>
					<td width="15%" align="right" class="skinLayout_info"><msg:message code="user.oldpwd"/><msg:message code="system.common.sign.colon"/></td>
					<td width="85%" class="skinLayout_lable">
					<form:password path="password" maxlength="25"/><font color="red">&nbsp;*&nbsp;<form:errors path="password" /></font>
					</td>
				</tr>
				<tr>
