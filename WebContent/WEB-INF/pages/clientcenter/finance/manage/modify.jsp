...
$(document).ready(function(){
	...
	$("#uploadify").uploadify({
		...
		'height'         : 24,
		'onInit'      	 : function() {
			 var temp = "${wealthManagement.image}";
		     if(temp != " " && temp != ""){
		    	 var imgUrl = $("#url").attr("src");
			     ...
			     var showpath = "<div id='"+id+"'><span>";
			        ...
			        showpath += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
			        showpath += "<a href='#' class='delete' id='"+id+"' onclick=\"del('"+id+"','"+fileName+"','"+${wealthManagement.id}+"')\">删除</a><br></div>";
...
//删除上传文件
function del(id, fileName, wid){
	$.post("deleteImgFile.json", {image :fileName, id :wid },function(data){});
	$("#image").val("");
	$('#'+id).remove();
	$("#img").text("");
	$("#img").hide();
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="skinMain">
	...
	<tr>
		<td width="100%">
				...
				<input type="hidden" name="id" value="${wealthManagement.id}" />
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
					<tr>
						...
						<form:input path="name" /><font color="red">&nbsp;*&nbsp;<form:errors path="name" /></font>
						</td>
					</tr>
					<tr>
						...
						<td width="85%" class="skinLayout_lable">
						<form:input path="address" /><font color="red">&nbsp;*&nbsp;<form:errors path="address" /></font>
						</td>
					</tr>
					<tr>
						...
						<form:input path="phone" /><font color="red"><form:errors path="phone" /></font>
						</td>
					</tr>
					<tr>
						...
						<td width="70%" class="skinLayout_lable">
						<form:input path="fax" /><font color="red"><form:errors path="fax" /></font>
						</td>
					</tr>
					<tr>
						...
						<td width="70%" class="skinLayout_lable">
						<form:input path="accuracy" /><font color="red">&nbsp;&nbsp;<form:errors path="accuracy" /></font>
						</td>
					</tr>
					<tr>
						...
						<td width="70%" class="skinLayout_lable">
						<form:input path="latitude" /><font color="red">&nbsp;&nbsp;<form:errors path="latitude" /></font>
						</td>
					</tr>
					<tr>
						...
						<td width="85%" class="skinLayout_lable">
							...
							<div id="mytest"></div>
							<div id="img" ><img id="url" src="${base}/${imagePath}/${wealthManagement.image}" align="absmiddle"/></div>
						</td>
					</tr>
					<tr>
						...
						<td width="70%" class="skinLayout_lable">
						<form:textarea path="description" rows="6" cols="40"/><font color="red">&nbsp;&nbsp;<form:errors path="description" /></font>
						</td>
					</tr>
					<tr>
