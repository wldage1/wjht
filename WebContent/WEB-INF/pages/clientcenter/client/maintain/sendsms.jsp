...
$(document).ready(function(){
	$("#btnok").click(function(){
		...
		var url = "${base}/clientcenter/client/maintain/dosendsms.json" + "";
		$.ajax({
			url:url,
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
						<tr>
							...
							<td width="85%" class="skinLayout_lable">
								 &nbsp短信模板：尊敬的{1}，款项会在3个工作日内下发到您的账户，请注意查收。<br>
								 &nbsp示例： 尊敬的xxx您好，{&nbsp您在x月x日于我公司申请的xxxx元额度的贷款已成功批款&nbsp}，款项会在3个工作日之内下发到您的账户，请注意查收。<br>
						...
						<tr>
							...
							<td width="85%" class="skinLayout_lable">
								<span>尊敬的&nbsp${client.name}&nbsp您好，</span><br>
								<form:input type="text" id="sms" path="sms" placeholder="您在x月x日于我公司申请的xxxx元额度的贷款已成功批款" maxlength="65" style="width: 420px;" /><font color="red">&nbsp;*&nbsp;<form:errors path="sms" delimiter=","/></font><br>
								<span>，款项会在3个工作日之内下发到您的账户，请注意查收。</span><br>
							</td>
						</tr>
