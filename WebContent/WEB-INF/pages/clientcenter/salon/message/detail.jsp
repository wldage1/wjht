		...
		<td width="100%">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
				<tr>
					...
					<form:input path="title" value="${salonMessage.title}" disabled='true' />
					</td>
				</tr>
				<tr>
					...
					<td width="85%" class="skinLayout_lable">
					<form:input path="meetingPlace" value="${salonMessage.meetingPlace}" disabled='true' />
					</td>
				</tr>
				<tr>
					...
					<input type="text" name="meetingTime" value="${salonMessage.meetingTime}" disabled='true' />
					</td>
				</tr>
				<tr>
					<td width="15%" align="right" class="skinLayout_info"><msg:message code="salonMessage.status"/><msg:message code="system.common.sign.colon"/></td>
					<td width="70%" class="skinLayout_lable">
					<form:input path="statusViewName" value="${salonMessage.statusViewName}" disabled='true' />
					</td>
				</tr>
				<tr>
					...
					<td width="70%" class="skinLayout_lable">
					<form:textarea cols="40" rows="6" path="meetingContent" value="${salonMessage.meetingContent}" readonly='true' />
					</td>
				</tr>
				<tr>
