			...
			<form:form method="post" action="save" commandName="consult">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
					<tr>
						...
						<form:input path="name" onchange="this.value=$.trim(this.value)" maxlength="20"/><font color="red">&nbsp;*&nbsp;<form:errors path="name" /></font>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<form:input path="mobilePhone" onchange="this.value=$.trim(this.value)" /><font color="red">&nbsp;*&nbsp;<form:errors path="mobilePhone" /></font>
						</td>
					</tr>
					<tr>
						...
						<td width="70%" class="skinLayout_lable">
						<form:textarea cols="40" rows="6" path="content" onchange="this.value=$.trim(this.value)" /><font color="red">&nbsp;&nbsp;<form:errors path="content" /></font>
						</td>
					</tr>	
					<tr>
