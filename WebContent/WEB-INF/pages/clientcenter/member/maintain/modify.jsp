		...
		<tr>
			<td width="100%">
				<form:form method="post" action="save" commandName="member">
					<form:hidden path="id"/>
					<form:hidden path="c"/>
					<form:hidden path="prompt" value="memberName"/>
					<form:hidden path="modifyPassWordFlag"/>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="skinLayout">
						...
						<tr>
							...
							<td width="85%" class="skinLayout_lable">
								<form:input path="userName" maxlength="25" readonly="true"/><font color="red">&nbsp;*&nbsp;<form:errors path="userName" delimiter=","/></font>
							</td>
						</tr>
						<tr>
							...
							<td width="85%" class="skinLayout_lable">
								<form:input path="mobilePhone" maxlength="11" /><font color="red">&nbsp;*&nbsp;<form:errors path="mobilePhone" delimiter=","/></font>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="85%" class="skinLayout_lable">
								<a id="resetPassWord" href="#" onclick="resetPassWord(this);" <c:if test="${!empty member.modifyPassWordFlag}">style="display:none"</c:if>><msg:message code="member.button.resetPassWord"/></a>
								<div id="passWordDiv" <c:if test="${empty member.modifyPassWordFlag}">style="display:none"</c:if>>
									<form:password path="passWord" maxlength="6" onpaste="return false;"/>
									<a href="#" onclick="returnResetPassWord();"><msg:message code="member.button.returnResetPassWord"/></a>
									<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;<form:errors path="passWord" delimiter=","/></font>
								</div>
							</td>
						</tr>
						<tr id="confirmPassWordDiv">
						...
						<tr>
							...
							<td width="85%" class="skinLayout_lable">
								<form:select path="level" items="${levelList}" itemValue="value" itemLabel="name" ></form:select>
						...
						<tr>
							...
							<td width="85%" class="radioTD">
								<form:radiobuttons path="sex" items="${genderList}" itemValue="value" itemLabel="name"/><font color="red">&nbsp;*&nbsp;<form:errors path="sex"/></font>
							</td>
						</tr>
						<tr>
							...
							<td width="85%" class="radioTD">
								<form:radiobuttons path="status" items="${memberStatusList}" itemValue="value" itemLabel="name"/><font color="red">&nbsp;*&nbsp;<form:errors path="status"/></font>
							</td>
						</tr>
						<tr>
