...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="skinMain">
			<tr>
				<td width="100%">
					<form:form method="post" action="updateSingleChoice" commandName="question" onsubmit="return checkSingleChoiceSumit(this);">
						<form:hidden path="c"/>	
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
							<tr>
							<td  colspan="2" style="font-size: 14px;"><b><msg:message code="question.singlechoice" /></b></td>
							</tr>
							<tr>
