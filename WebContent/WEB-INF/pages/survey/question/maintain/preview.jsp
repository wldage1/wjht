...
<body>
<a href="#" onclick="closePreviewPage();" class="closePreviewPage">关闭</a>
<form:questionnairePreview questionList="${questionList }" questionnaire="${questionnaire }"></form:questionnairePreview>
</body>
</html>